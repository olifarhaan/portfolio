...
const Footer = () => {
  return (
    <footer className="mt-auto w-full shadow py-10">
      <div className="flex flex-col sm:flex-row sm:justify-between gap-2 px-3 max-w-6xl mx-auto">
        <div className="text-sm text-gray-400 text-center sm:text-left">© {new Date().getFullYear()} <Link to="/" className="hover:underline">M. Ali Farhan</Link>. All Rights Reserved.</div>
